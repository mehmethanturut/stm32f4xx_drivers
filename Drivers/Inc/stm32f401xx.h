...
/**
 * @brief TIM1 Register Definition Structure
 * 
 * This structure represents the TIM1 peripheral registers.
 */
typedef struct {
    /**
     * @brief TIM1 Control Register 1 (TIMx_CR1)
     */
    typedef struct {
    ...
    /**
     * @brief TIM1 Control Register 2 (TIMx_CR2)
     */
    typedef struct {
        ...
        uint32_t OIS1N   :1;  /**< Output Idle state 1 (complementary) */
        uint32_t OIS2    :1;  /**< Output Idle state 2 */
        uint32_t OIS2N   :1;  /**< Output Idle state 2 (complementary) */
        uint32_t OIS3    :1;  /**< Output Idle state 3 */
        uint32_t OIS3N   :1;  /**< Output Idle state 3 (complementary) */
        uint32_t OIS4    :1;  /**< Output Idle state 4 */
        uint32_t res2    :17; /**< Reserved */
    } TIMx_CR2_t;

    /**
     * @brief TIM1 Slave Mode Control Register (TIMx_SMCR)
     */
    typedef struct {
        ...
        uint32_t res2    :16; /**< Reserved */
    } TIMx_SMCR_t;

    /**
     * @brief TIM1 DMA/Interrupt Enable Register (TIMx_DIER)
     */
    typedef struct {
        ...
        uint32_t res     :17; /**< Reserved */
    } TIMx_DIER_t;

    /**
     * @brief TIM1 Status Register (TIMx_SR)
     */
    typedef struct {
    ...
    /**
     * @brief TIM1 Event Generation Register (TIMx_EGR)
     */
    typedef struct {
    ...
    /**
     * @brief TIM1 Capture/Compare Mode Register 1 (TIMx_CCMR1)
     */
    typedef struct {
    ...
    /**
     * @brief TIM1 Capture/Compare Mode Register 2 (TIMx_CCMR2)
     */
    typedef struct {
    ...
    /**
     * @brief TIM1 Capture/Compare Enable Register (TIMx_CCER)
     */
    typedef struct {
        ...
        uint32_t res     :18; /**< Reserved */
    } TIMx_CCER_t;


    /**
     * @brief TIM1 Counter Register (TIMx_CNT)
     */
    typedef struct {
    ...
    /**
     * @brief TIM1 Prescaler Register (TIMx_PSC)
     */
    typedef struct {
    ...
    /**
     * @brief TIM1 Auto-Reload Register (TIMx_ARR)
     */
    typedef struct {
    ...
    /**
     * @brief TIM1 Capture/Compare Registers (TIMx_CCR1 - TIMx_CCR4)
     */
    typedef struct {
        uint32_t CCR     :16; /**< Capture/Compare value */
        uint32_t res     :16; /**< Reserved */
    } TIMx_CCR1_t;
    ...
    /**
     * @brief TIM1 Break and Dead-Time Register (TIMx_BDTR)
     */
    typedef struct {
